    ...
    <div className="flex flex-col">
      ...
      <section className="hero-metal px-5 lg:px-10 pt-10 pb-8 border-b border-[#141d2c]">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-[#ff1f1f] text-[11px] font-semibold tracking-[1.5px] uppercase">Financeiro</span>
        </div>
        ...
        <p className="text-[#7a9ab5] text-[15px]">
          {payments.length > 0
            ? `${payments.length} transaç${payments.length !== 1 ? "ões" : "ão"} registrada${payments.length !== 1 ? "s" : ""}`
            : "Histórico completo das suas transações"}
        </p>
      </section>

      <div className="px-5 lg:px-10 py-8 flex flex-col gap-6">
