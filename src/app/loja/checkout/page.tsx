            ...
            <div className="flex-1 bg-[#0a0f1a] border border-[#141d2c] rounded-[16px] p-6 lg:p-8">
              ...
              {step === 1 && (
                <div className="flex flex-col gap-5">
                  ...
                  <button
                    onClick={() => { if (nome && email && cpf && telefone) setStep(2); }}
              ...
              {step === 2 && (
                <div className="flex flex-col gap-5">
                  ...
                  <button
                    onClick={() => { if (cep && rua && numero && bairro && cidade && estado) setStep(3); }}
                ...
                <div className="flex flex-col gap-5">
                  ...
                  {payMethod === "boleto" && (
                    <div className="bg-[#080f1a] border border-[#1c2a3e] rounded-[10px] p-5 text-center">
                      <p className="text-[#7a9ab5] text-[13px]">O boleto será enviado para <strong className="text-[#dce8ff]">{email}</strong> após a confirmação do pedido.</p>
