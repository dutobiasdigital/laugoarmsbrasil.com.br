...
export default function CarrinhoPage() {
  ...
  const frete     = subtotal >= 20000 ? 0 : 1990; // frete grátis acima de R$200
  ...
  if (items.length === 0) {
    return (
      <div className="min-h-screen bg-[#070a12] flex flex-col">
        <Header />
        <div className="mt-16 flex-1 flex flex-col items-center justify-center gap-6 py-24 px-5">
        ...
        <div className="px-5 lg:px-20 py-10">
          ...
          <div className="mb-6 bg-[#0e1520] border border-[#141d2c] rounded-[10px] px-5 py-4">
            ...
            <div className="h-1.5 bg-[#141d2c] rounded-full overflow-hidden">
              <div
                className="h-full bg-[#ff1f1f] rounded-full transition-all"
              ...
              {items.map(item => (
                <div key={item.productId + (item.variationId ?? "")}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {item.variationName && (
                      <p className="text-[#526888] text-[12px] mt-0.5">{item.variationName}</p>
                    )}
