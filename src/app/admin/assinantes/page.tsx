  ...
  return (
    <>
      ...
      <div className="bg-[#18181b] border border-[#27272a] rounded-[10px] overflow-hidden">
        <div className="bg-[#27272a] px-5 py-3 grid grid-cols-8 gap-3">
              ...
              <div key={u.id}>
                ...
                <div className="px-5 py-3.5 grid grid-cols-8 gap-3 items-center">
                  <div className="flex items-center gap-2 min-w-0">
                    <div className="w-[28px] h-[28px] rounded-full bg-[#27272a] flex items-center justify-center text-[11px] text-[#a1a1aa] font-semibold shrink-0">
                      {u.name.slice(0, 2).toUpperCase()}
                    </div>
                    <p className="text-[#d4d4da] text-[13px] truncate">{u.name}</p>
                  </div>
                  <p className="text-[#a1a1aa] text-[13px] truncate">{u.email}</p>
