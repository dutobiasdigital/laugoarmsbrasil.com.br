        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
          ...
          <div className="lg:col-span-2">
            ...
            <textarea
              ...
              className="bg-[#141d2c] border border-[#1c2a3e] rounded-[6px] px-3 py-2.5 text-[14px] text-[#d4d4da] placeholder-[#253750] focus:outline-none focus:border-[#ff1f1f] w-full resize-none"
            />
          </div>
        </div>
