...
const btnCls =
  "h-[28px] min-w-[28px] px-1.5 rounded text-[12px] text-[#a1a1aa] hover:text-white hover:bg-[#3f3f46] transition-colors flex items-center justify-center select-none";
